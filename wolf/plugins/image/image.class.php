...
/**
 * Image manipulation support using [GD](http://php.net/GD).
 * Allows images to be resized, cropped, etc.
 * 
 * @author     Kohana Team
 * @copyright  Kohana Team
...
class Image {
	...
	public static function check()
	{
		...
		else
		{
			...
			Image::$_bundled = (bool) preg_match('/\bbundled\b/i', $info['GD Version']);
		}
