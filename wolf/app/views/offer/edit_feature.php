...
<form action="<?php echo get_url('offer/edit_feature/'.$feature->id); ?>" method="post" enctype="multipart/form-data"> 
...
<br />
<img src="<?php echo URL_PUBLIC.'public/offer/feature/'.$feature->filename; ?>" style="max-width:100%; clear:both; display:block;" />

<p class="buttons">
    <input class="button" name="commit" type="submit" accesskey="s" value="<?php echo __('Save'); ?>" />
    <input class="button" name="continue" type="submit" accesskey="e" value="<?php echo __('Save and Continue Editing'); ?>" />
    <?php echo __('or'); ?> <a href="<?php echo get_url('offer/edit/'.$feature->offerid); ?>"><?php echo __('Cancel'); ?></a>
</p>
