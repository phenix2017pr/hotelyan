...
<form id="page_edit_form" action="<?php if ($action == 'add') echo get_url('page/add'); else echo  get_url('page/edit/'.$page->id); ?>" method="post" enctype="multipart/form-data">
        ...
        <div id="metadata" class="page">
            <div id="div-metadata" title="<?php echo __('Metadata'); ?>">
              <table cellpadding="0" cellspacing="0" border="0">
                ...
                <?php endif; ?>
                <tr>
                  <td class="label"><label for="page_breadcrumb"><?php echo __('Meta Title'); ?></label></td>
                  ...
                  <td class="field">
                      ...
                      <?php foreach ($layouts as $layout): ?>
                        <option value="<?php echo $layout->id; ?>"
                        	<?php echo $layout->id == $page->layout_id ? ' selected="selected"': (!isset($page->layout_id) && $layout->id=='0'?' selected="selected"':''); ?>>
...
?>
    <div id="part-tabs" class="content tabs">
        ...
        <ul class="tabNavigation">
            ...
            <?php } 
  			 ...
  			 if ($page->id == 1) {
  			 	//echo '<li id="part-homepage-setting-tab" class="tab"><a href="#part-homepage-setting-content">Page Content Settings</a></li>';
  			 }
			?>
    ...
    <div id="part-content" class="pages">
	  ...
	  echo '<div id="part-homepage-setting-content" class="page" style="display: block;">';
	  echo new View('page/part_homepage_setting', array('pagesetting' => $pagesetting));
	  echo '</div>'
	  ?>
    </div>
    ...
    <div class="row">
      <p><label for="page_behavior_id"><?php echo __('Location'); ?></label>
        <select id="type" name="page[location]">
          <!-- <option value="main" <?php if ($page->location == "main") echo ' selected="selected"'; ?>><?php echo __('Main'); ?></option> -->
          <option value="top" <?php if ($page->location == "top") echo ' selected="selected"'; ?>><?php echo __('Top'); ?></option>
          <option value="footer" <?php if ($page->location == "footer") echo ' selected="selected"'; ?>><?php echo __('Footer'); ?></option>
		      <!-- <option value="footer-bottom" <?php if ($page->location == "footer-bottom") echo ' selected="selected"'; ?>><?php echo __('Footer Bottom'); ?></option> -->
        </select>
      </p>

      <p><label for="page_behavior_id"><?php echo __('Page Type'); ?></label>
        <select id="type" name="page[type]">
          <option value="content" <?php if ($page->type == "content") echo ' selected="selected"'; ?>><?php echo __('Content'); ?></option>
          <option value="link" <?php if ($page->type == "link") echo ' selected="selected"'; ?>><?php echo __('External Link'); ?></option>
        </select>
      </p>
...
<?php endif; ?>
      ...
      <p><label for="page_url_target"><?php echo __('Open in New Window'); ?></label>
	  <input type="checkbox" id="newwindow" name="page[newwindow]" <?php echo (isset($page->newwindow) && $page->newwindow == 1? 'checked' : ''); ?> />
<?php Observer::notify('view_page_edit_plugins', $page); ?>

      <p><label for=""><?php echo __('External Link'); ?></label>
         <input type=text id="external_url" name="page[external_url]" value="<?php echo $page->external_url ?>" size=50>
      </p>
