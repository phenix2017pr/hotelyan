...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <head>
    ...
    <link href="<?php echo URI_PUBLIC; ?>wolf/admin/stylesheets/jquery-ui-1.8.6.css" media="screen" rel="Stylesheet" type="text/css" />
	...
	<link type="text/css" href="<?php echo URI_PUBLIC; ?>wolf/admin/stylesheets/jquery.timepicker.css" media="screen" rel="stylesheet"  />

	<script type="text/javascript" src="<?php echo URI_PUBLIC; ?>wolf/admin/javascripts/jquery.timepicker.min.js"></script>
    ...
    <div id="header">
      ...
      <div id="mainTabs">
        ...
        <ul>
          ...
          <li id="page-plugin" class="plugin"><a href="<?php echo get_url('banner'); ?>"<?php if ($ctrl=='banner') echo ' class="current"'; ?>><?php echo __('Banner'); ?></a></li>
          <li id="page-plugin" class="plugin"><a href="<?php echo get_url('offer'); ?>"<?php if ($ctrl=='offer') echo ' class="current"'; ?>><?php echo __('Offer'); ?></a></li>
          <li id="page-plugin" class="plugin"><a href="<?php echo get_url('room'); ?>"<?php if ($ctrl=='room') echo ' class="current"'; ?>><?php echo __('Rooms'); ?></a></li>
          <li id="page-plugin" class="plugin"><a href="<?php echo get_url('fnb'); ?>"<?php if ($ctrl=='fnb') echo ' class="current"'; ?>><?php echo __('F&B Menu'); ?></a></li>
          <li id="page-plugin" class="plugin"><a href="<?php echo get_url('fnbgallery'); ?>"<?php if ($ctrl=='fnbgallery') echo ' class="current"'; ?>><?php echo __('F&b Slide'); ?></a></li> 
