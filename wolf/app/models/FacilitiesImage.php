 ...
 *
 */
class FacilitiesImage extends Record {
    const TABLE_NAME = 'facilitiesimage';
    ...
    */
     ...
     /**
     * Find a FacilitiesImage by id
     *
     * @param int $id
     * @return mixed A FacilitiesImage or false on failure.
     */
    public static function findById($id) {
        return self::findByIdFrom('FacilitiesImage', $id);
    }

    public static function findBy($column, $value) {
        return Record::findOneFrom('FacilitiesImage', $column.' = ?', array($value));
    }
    ...
    public static function find($args = null) {
		...
		$tablename = self::tableNameFromClassName('FacilitiesImage');
		...
		// Run!
		if ($limit == 1) {
			return $stmt->fetchObject('FacilitiesImage');
		}
		else {
			$objects = array();
			while ($object = $stmt->fetchObject('FacilitiesImage')) {
				$objects[] = $object;
			}
			return $objects;
		}
    ...
    /**
     * Find a FacilitiesImage by its facilities id.
     *
     * @param string $id
     * @return mixed A FacilitiesImage or false on failure.
     */
    public static function findByFacilitiesId($id) {
        $where = self::tableNameFromClassName('FacilitiesImage').'.facilitiesid='.(int)$id;
    ...
    public function getColumns() {
        return array('id', 'facilitiesid', 'reference_code', 'url', 'tagcontent', 'publish', 'created_on', 'updated_on', 'created_by_id', 'updated_by_id');
    }
    */
}