        ...
        return this.each(function (p, t) {
            function y(f, c, e) {
                ...
                k.ajax({
                    ...
                    success: function (a) {
                        if (a.query) {
                            if (0 < a.query.results.channel.length) for (var c = a.query.results.channel.length, b = 0; b < c; b++) z(t, a.query.results.channel[b],
                            e);
            ...
            var z = function (f, c, e) {
                ...
                if ("Yahoo! Weather Error" != c.description) {
					...
					var count=1;
                    var b = '<div id="forecast_'+count+'"	 class="weatherItem ' + m + " " + daynight + '"';
                    e.image && (b += ' style=""');
                    b = b + ">" + ('<div class="weatherCity">' + c.location.city + " NOW</div>");
                    e.country && (b += '<div class="weatherCountry">' + c.location.country + "</div>");
                    b += '<div class="weatherTemp">' + c.item.condition.temp + "&deg; C</div>";
                    b += '';
                    e.highlow && (b += '');
                    ...
                    if (e.forecast) {
                        ...
                        for (var h = 0; h < g; h++) b += '<div class="weatherForecastItem day' + (h + 1) + '" style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/' + a[h].code + 'd.png); background-repeat: no-repeat;">', b += 
						'<div class="weatherForecastDate" id="forecastdate_'+(h+1)+'">' + a[h].date + "</div>",  b += '<div class="weatherForecastRange" id="forecasttemp_'+(h+1)+'">' + a[h].high + "&deg; C</div>", b += "</div>";
                        b += "</div>"
                    }
